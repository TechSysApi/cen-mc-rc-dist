...
export enum BarCodeSymbology {
    /** Not recognized barcode symbol */
    NOT_RECOGNIZED,
    /** Code 128 used for national shipment number, products, box-id and conveying aid */
    CODE_128,
    /** Data matrix code */
    DATA_MATRIX,
    /** Code 39 used for mail items from countries like Russia or Italy */
    CODE_39,
    /** Interleaved 2 of 5 Code used by the customs for imported mail items. */
    I2OF5,
    /** QR-Code used for advertising mail. */
    QR
}

/**
 * The result status of the barcode recognition.
...
export interface BarCode {
    ...
    status: BarCodeStatus // [DEPRECATED] Replaced by BarcodeSymbology.NOT_RECOGNIZED. Field will be removed in future release.
}
